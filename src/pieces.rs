...
const fn create_pst_pawn_eg() -> [i32; 64] {
    let pst: [i32; 64] =
        [0,   0,   0,   0,   0,   0,   0,   0,
...
const fn create_pst_knight_mg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_knight_eg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_bishop_mg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_bishop_eg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_rook_mg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_rook_eg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_queen_mg() -> [i32; 64] {
    let pst: [i32; 64] =
...
const fn create_pst_queen_eg() -> [i32; 64] {
    let pst: [i32; 64] =
...
pub const PST_END_GAME: [[i32; 64]; 6] = [
    create_pst_pawn_eg(),
    create_pst_knight_eg(),
    create_pst_bishop_eg(),
    create_pst_rook_eg(),
    create_pst_queen_eg(),
    create_pst_king_eg(),
];
